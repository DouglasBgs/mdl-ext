...
/***/ function(module, exports, __webpack_require__) {
	...
	var _apply = __webpack_require__(64);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsonUtils = __webpack_require__(20);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var COLLAPSIBLE_CONTROL_CLASS = 'mdlext-collapsible-control';
	    ...
	    this.keyDownHandler = function (event) {
	      if (event.keyCode === _constants.VK_ENTER || event.keyCode === _constants.VK_SPACE) {
	        if (document.createEvent) {
	          ...
	          _this.controlElement.dispatchEvent(evt);
	        } else if (document.createEventObject) {
	          _this.controlElement.fireEvent('onclick');
	        } else if (typeof _this.controlElement.onclick == 'function') {
	          _this.controlElement.onclick();
	        }
	        //event.stopPropagation();
	        //event.preventDefault();
	      }
	  ...
	  (0, _createClass3.default)(Collapsible, [{
	    ...
	    value: function addRegionElement(region) {
	      if (!region.hasAttribute('id')) {
	        region.id = 'region-' + (0, _stringUtils.randomString)();
	      }
	    ...
	    value: function init() {
	      ...
	      var initControl = function initControl() {
	        ...
	        _this2.controlElement_ = _this2.element.querySelector('.' + COLLAPSIBLE_CONTROL_CLASS);
	        if (!_this2.controlElement && _this2.element.classList.contains(COLLAPSIBLE_CONTROL_CLASS)) {
	          _this2.controlElement_ = _this2.element;
	        }
	        if (!_this2.controlElement) {
	        ...
	        // Add tabindex
	        if (!_this2.controlElement.hasAttribute('tabindex')) {
